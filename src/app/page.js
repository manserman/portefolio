...
export default function Home() {
  ...
  const s_nav = "text-white text-sm p-3 w-full text-center hover:bg-gray-700 mt-1"; // Ajout de mt-1 pour réduire la marge supérieure
      ...
      <div className={s_main}>
        ...
        <div className="h-[7%] w-[100%] pt-10 pl-10  " id="accueil" >
          ...
          <div className="text-justify tracking-wide text-sm font-serif w-[85%]" >
            ...
            et des outils d'administration et rporting ,en mettant l'accent sur les tests unitaires pour garantir la 
            ...
            {competences.map((item, index) => {
              return (
                <div
                  ...
                  className={
                    "h-full w-[70%] hover:scale-110 flex items-center justify-center border border-black font-semibold text-white " +
                    item.color
                  }
                >
                  {item.poste}
